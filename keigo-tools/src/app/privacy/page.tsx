    ...
    <div className="max-w-2xl mx-auto space-y-6 text-sm">
      ...
      <section className="space-y-2">
        ...
        <p className="text-muted-foreground">
          ...
          入力された文章・メール内容はAI生成処理にのみ使用し、サーバーに保存しません。
      ...
      <section className="space-y-2">
        ...
        <p className="text-muted-foreground">
          ...
          ただし、決済処理のためにStripe Inc.に必要な情報を提供します。
        </p>
      </section>

      <section className="space-y-2">
        <h2 className="font-semibold">4. Cookieの使用</h2>
        <p className="text-muted-foreground">
          当サービスではCookieおよびlocalStorageを使用して利用回数やサブスクリプション状態を管理します。
          ブラウザの設定によりこれらを無効化することができますが、一部機能が利用できなくなる場合があります。
        </p>
      </section>
      ...
      <section className="space-y-2">
        <h2 className="font-semibold">6. お問い合わせ</h2>
        <p className="text-muted-foreground">
