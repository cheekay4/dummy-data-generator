...
const FEATURES = [
  { label: '生成回数', free: '3回/日', pro: '無制限' },
  { label: 'テンプレート', free: true, pro: true },
  { label: '敬語解説', free: true, pro: true },
  { label: 'メールアプリ連携', free: true, pro: true },
  { label: 'トーン調整', free: false, pro: true },
      ...
      <table className="w-full text-sm">
        ...
        <tbody>
          <tr className="border-t">
            ...
            <td className="px-4 py-3 text-center font-semibold text-primary">290円</td>
          </tr>
          {FEATURES.map((f) => (
