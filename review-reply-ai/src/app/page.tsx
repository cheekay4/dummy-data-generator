  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'はい。ログインすれば1日5回まで完全無料です。性格診断もプロファイル設定も無料。ログイン不要でも1日3回までお試しいただけます。',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '「友達に久しぶりに会ったら？」「旅行の話をどう伝える？」など日常のちょっとした場面を10問聞くだけ。接客やお店の質問は一切ありません。それなのに出てくる返信が「まるで自分が書いたみたい」と驚く方が多いです。過去のメールや返信文をお持ちなら「テキスト学習」がおすすめ。2〜3件コピペするだけです。',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '性格診断やテキスト学習をもとにAIが自動生成する「あなたの返信の人格」です。温かみ・社交性・丁寧さ・独自性の4つの軸であなたらしさを数値化し、返信のトーンを再現します。あとからスライダーで微調整もできます。1人分は無料です。',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'はい。星1の厳しい口コミにも、感情的にならない丁寧な返信を生成します。Proなら「クレーム対応モード」の補助スタイルで、謝罪・改善・再来店誘導まで含めたプロフェッショナルな返信を作れます。',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'はい。性格診断をスキップしても、トーン（丁寧・フレンドリー・カジュアル）を選ぶだけで返信を生成できます。ただし、返信プロファイルを作成すると、あなたの文体がより正確に再現されるためおすすめです。',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'クレーム対応・お祝い・常連さん向け・ビジネス・インバウンドなど、シーンに応じて返信プロファイルに上乗せする調整モードです（Pro限定・5種）。あなたの性格はそのままに、状況に合わせた最適な返信になります。',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Googleマップ・食べログ・ホットペッパー・Amazon・楽天・じゃらん・トリップアドバイザーなど8つのプラットフォームに対応しています。プラットフォームごとに適切なトーンで返信を生成します。',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '外国語で書かれた口コミの読み取りは全プランで対応しています。多言語での返信文の生成はPro限定です（日本語・英語・中国語・韓国語）。',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '過去に書いたメールや口コミ返信文を2〜3件コピペするだけで、AIがあなたの文体・トーンを分析して返信プロファイルを作成する機能です。性格診断より正確にあなたらしさを再現できます。Freeプランから利用できます。',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '多くの場合そのまま使えますが、お店の固有情報（メニュー名・スタッフ名など）は必要に応じて追記してください。生成後に「手直しアドバイス」も表示されるので、より良い返信に仕上げることができます。',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'はい。マイページからいつでも解約できます。解約後は次の課金日をもってFreeプランに移行します。返信プロファイルのデータはそのまま残ります。',
      },
    },
  ],
}
