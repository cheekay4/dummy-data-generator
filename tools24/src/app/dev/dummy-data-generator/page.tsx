...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "日本の氏名・住所・電話番号・メール・会社名・マイナンバーなど22種類のテストデータをブラウザだけで瞬時に生成。CSV/JSON/TSV/SQL形式でダウンロード可能。データは送信されません。",
    url: "https://tools24.jp/dev/dummy-data-generator",
  },
  alternates: {
    canonical: "https://tools24.jp/dev/dummy-data-generator",
  },
};
...
const faqs = [
  {
    question: "生成されたデータは実在の個人情報ですか？",
    answer:
      "いいえ。全てアルゴリズムで生成されるフィクションデータです。実在の人物・住所・電話番号とは一切関係ありません。",
  },
  {
    question: "クレジットカード番号は本物ですか？",
    answer:
      "いいえ。「9999」「9998」「9997」「9996」で始まるテスト専用プレフィックスを使用しており、実在のカードネットワークには属しません。Luhnチェックは通りますが、決済には使用できません。",
  },
  {
    question: "マイナンバーは実在のものですか？",
    answer:
      "いいえ。マイナンバーの公式チェックデジットアルゴリズムに基づいて生成した架空の番号です。実在のマイナンバーとは一切関係ありません。",
  },
  {
    question: "データはサーバーに送信されますか？",
    answer:
      "送信されません。全ての処理はお使いのブラウザ内で完結しています。",
  },
  {
    question: "一度に何件まで生成できますか？",
    answer: "最大500件まで生成できます。",
  },
];
...
export default function DummyDataGeneratorPage() {
  return (
    <>
      ...
      <AffiliateTextLink {...affiliateDevTools['/dev/dummy-data-generator']} />
    </>
  );
}
