import { DetectionResult, DETECTION_LABELS, DetectionType } from "@/lib/masking/types";

interface DetectionSummaryProps {
  result: DetectionResult;
}

export function DetectionSummary({ result }: DetectionSummaryProps): React.JSX.Element {
