...
import { DetectionResult } from "@/lib/masking/types";
...
export function MaskingControls({ onMask, isProcessing, detectionResult, disabled }: MaskingControlsProps): React.JSX.Element {
  return (
